...
"""autogenerated by genpy from robotics_project/PickUpPoseActionResult.msg. Do not edit."""
import sys
...
class PickUpPoseActionResult(genpy.Message):
  ...
  _type = "robotics_project/PickUpPoseActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','robotics_project/PickUpPoseResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = robotics_project.msg.PickUpPoseResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = robotics_project.msg.PickUpPoseResult()
