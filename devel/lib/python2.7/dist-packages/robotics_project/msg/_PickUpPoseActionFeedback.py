...
"""autogenerated by genpy from robotics_project/PickUpPoseActionFeedback.msg. Do not edit."""
import sys
...
class PickUpPoseActionFeedback(genpy.Message):
  ...
  _type = "robotics_project/PickUpPoseActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','robotics_project/PickUpPoseFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = robotics_project.msg.PickUpPoseFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = robotics_project.msg.PickUpPoseFeedback()
