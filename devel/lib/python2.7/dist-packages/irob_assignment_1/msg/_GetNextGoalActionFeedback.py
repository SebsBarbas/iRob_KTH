...
"""autogenerated by genpy from irob_assignment_1/GetNextGoalActionFeedback.msg. Do not edit."""
import sys
...
class GetNextGoalActionFeedback(genpy.Message):
  _md5sum = "41ee39a227760fc2e6287fc850af7dfe"
  _type = "irob_assignment_1/GetNextGoalActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','irob_assignment_1/GetNextGoalFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetNextGoalActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = irob_assignment_1.msg.GetNextGoalFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = irob_assignment_1.msg.GetNextGoalFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_d3I().pack(_x.feedback.gain, _x.feedback.path.header.seq, _x.feedback.path.header.stamp.secs, _x.feedback.path.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.feedback.gain, _x.feedback.path.header.seq, _x.feedback.path.header.stamp.secs, _x.feedback.path.header.stamp.nsecs,) = _get_struct_d3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
