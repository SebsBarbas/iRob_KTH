...
"""autogenerated by genpy from irob_assignment_1/GetNextGoalActionResult.msg. Do not edit."""
import sys
...
class GetNextGoalActionResult(genpy.Message):
  _md5sum = "872853da52944b89240c62b49b1cdc6f"
  _type = "irob_assignment_1/GetNextGoalActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','irob_assignment_1/GetNextGoalResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetNextGoalActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = irob_assignment_1.msg.GetNextGoalResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = irob_assignment_1.msg.GetNextGoalResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_d3I().pack(_x.result.gain, _x.result.path.header.seq, _x.result.path.header.stamp.secs, _x.result.path.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.gain, _x.result.path.header.seq, _x.result.path.header.stamp.secs, _x.result.path.header.stamp.nsecs,) = _get_struct_d3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
