...
"""autogenerated by genpy from irob_assignment_1/GetNextGoalAction.msg. Do not edit."""
import sys
...
class GetNextGoalAction(genpy.Message):
  _md5sum = "29977b8e80977bb796f844f67dc89fde"
  _type = "irob_assignment_1/GetNextGoalAction"
...
"""
  ...
  _slot_types = ['irob_assignment_1/GetNextGoalActionGoal','irob_assignment_1/GetNextGoalActionResult','irob_assignment_1/GetNextGoalActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetNextGoalAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = irob_assignment_1.msg.GetNextGoalActionGoal()
      if self.action_result is None:
        self.action_result = irob_assignment_1.msg.GetNextGoalActionResult()
      if self.action_feedback is None:
        self.action_feedback = irob_assignment_1.msg.GetNextGoalActionFeedback()
    else:
      self.action_goal = irob_assignment_1.msg.GetNextGoalActionGoal()
      self.action_result = irob_assignment_1.msg.GetNextGoalActionResult()
      self.action_feedback = irob_assignment_1.msg.GetNextGoalActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_d3I().pack(_x.action_result.result.gain, _x.action_result.result.path.header.seq, _x.action_result.result.path.header.stamp.secs, _x.action_result.result.path.header.stamp.nsecs))
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_d3I().pack(_x.action_feedback.feedback.gain, _x.action_feedback.feedback.path.header.seq, _x.action_feedback.feedback.path.header.stamp.secs, _x.action_feedback.feedback.path.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_result.result.gain, _x.action_result.result.path.header.seq, _x.action_result.result.path.header.stamp.secs, _x.action_result.result.path.header.stamp.nsecs,) = _get_struct_d3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_feedback.feedback.gain, _x.action_feedback.feedback.path.header.seq, _x.action_feedback.feedback.path.header.stamp.secs, _x.action_feedback.feedback.path.header.stamp.nsecs,) = _get_struct_d3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
