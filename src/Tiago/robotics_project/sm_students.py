...
class StateMachine(object):
    def __init__(self):
        ...
        #self.pick_pose = rospy.get_param(rospy.get_name() + '/pickup_marker_pose')
        ...
        rospy.wait_for_service('/place_holder5', timeout=10)
        ...
        #self.pick_pub = rospy.Publisher("/pick_pose_topic", PoseStamped, queue_size=10)
        self.pick_pub = rospy.Publisher("/place_holder4", PoseStamped, queue_size=10)
    ...
    def check_states(self):
        ...
        while not rospy.is_shutdown() and self.state != 4:
            ...
            if self.state == 0:
                ...
                self.scene_srv = rospy.ServiceProxy('/place_holder5', SetBool)
